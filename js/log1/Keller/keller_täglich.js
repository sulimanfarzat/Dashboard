$(function() {
    ...
    var chartSpeed = Highcharts.chart('container-speed-keller', Highcharts.merge(gaugeOptions, {
        yAxis: {
            min: 0,
            max: 4000,
            title: {
    ...
    var chartRpm = Highcharts.chart('container-rpm-keller', Highcharts.merge(gaugeOptions, {
        yAxis: {
            min: 0,
            max: 60,
            title: {
        ...
        credits: {
            ...
            text: 'Die Zahlen vom: 04.01.2016'
        },
